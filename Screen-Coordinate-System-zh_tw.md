...
註: 這裡所稱的 `visio` 為 MapleBBS 3 之系統輸出入函式庫，非 PttBBS 中現名為 `vtuikit` 的使用者介面函式庫
...
`ANSILINELEN`     | `160` (MapleBBS 2.0.5) <br> - `511` (PttBBS) <br> - `500` (MapleBBS 3) | 原始字元座標之 x           | MapleBBS 2        | 單行最大字元數
