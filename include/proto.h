...
GCC_NONNULLS void cursor_show_mark(XO *xo, int row, int column, int cur_idx);
GCC_NONNULLS void cursor_clear_mark(XO *xo, int row, int column, int cur_idx, int pos_prev);
GCC_NONNULLS void cursor_bar_show(XO *xo, int row, int column, int width, int cur_idx);
GCC_NONNULLS void cursor_bar_clear(XO *xo, int row, int column, int width, int cur_idx, int pos_prev);
GCC_NONNULLS int cursor_bar_key(XO *xo, int row, int column, int width, int cur_idx, int pos_prev);
GCC_NONNULLS void cursor_show(XO *xo, int row, int column, int cur_idx);
GCC_NONNULLS void cursor_clear(XO *xo, int row, int column, int cur_idx, int pos_prev);
GCC_NONNULLS int cursor_key(XO *xo, int row, int column, int cur_idx, int pos_prev);
